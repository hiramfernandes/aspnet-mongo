...
namespace aspnet_mongo.Controllers
{
    ...
    public class CallbackController : ControllerBase
    {
        ...
        private async Task HandleReceiptUrl(string url, long messageId, CancellationToken cancellationToken)
        {
        ...
        private async Task HandleQrCode(string fileId, long chatMessageId, CancellationToken cancellationToken)
        {
        ...
        private async Task HandleImage(string fileId, long chatMessageId, CancellationToken cancellationToken)
        {
